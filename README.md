...
Currently exploring the intersection of **Embedded Systems, IoT, and Edge AI**, where code meets circuits.
...
- ⚙️ **Exploring STM32 and Raspberry Pi** for real-time embedded systems  
- 🌐 **Building my personal portfolio** to showcase work and open-source projects  
- 🤖 **Learning robotics and core electronics** alongside modern web development  
